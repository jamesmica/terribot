...
<style>
    ...
    :root {
        ...
        --shadow-subtle: 0 1px 6px rgba(15, 23, 42, 0.06);
    }
    ...
    .stApp {
        background: linear-gradient(135deg, #f7f9fc 0%, #eaf0f6 100%);
    }
    ...
    [data-testid="stChatMessageContainer"] li,
    [data-testid="stChatMessageContainer"] span {
        color: var(--text-primary);
    }
    ...
    /* Textes et labels */
    .stMarkdown, .stText, .stCaption, p, li, label, small {
        color: var(--text-secondary);
    }
